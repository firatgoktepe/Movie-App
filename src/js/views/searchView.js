import {elements, noResult} from '../base';
...
export const displayResults = (keyword,data) => {
    ...
    data.results.forEach(movie => {
        ...
        elements.movieListHeader.innerHTML = `for ${keyword}, ${data.total_results} result found.`;
        elements.movieListContainer.classList.add('d-block');    
        elements.movieList.insertAdjacentHTML('beforeend', html);
    })
  }else {
    noResult(elements.movieDetailsContainer);
  }
}