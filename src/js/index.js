...
import { elements, renderLoader, clearLoader , alert_msg, clearAlert, clearNoResult} from './base';
...
const searchController = async () => {
    ...
    if (keyword) {
        ...
        setTimeout(() => { clearAlert(elements.movieDetailsContainer); }, 1000);
        //setTimeout(() => { clearNoResult(elements.movieDetailsContainer); }, 1000);

    } else {
        //alert('anahtar kelime girmelisiniz');
        alert_msg(elements.movieDetailsContainer);
    }
}
