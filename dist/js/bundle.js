...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Movie\", function() { return Movie; });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nclass Movie {\n  constructor(id) {\n    this.id = id;\n  }\n\n  async getMovie() {\n    const response = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_0__[\"base_url\"]}/movie/${this.id}?api_key=${_config__WEBPACK_IMPORTED_MODULE_0__[\"api_key\"]}`);\n    this.data = await response.json();\n  }\n\n}\n\n//# sourceURL=webpack:///./src/js/models/Movie.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nclass Search {\n  constructor(keyword) {\n    this.keyword = keyword;\n  }\n\n  async getResults() {\n    const response = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_0__[\"base_url\"]}/search/movie?api_key=${_config__WEBPACK_IMPORTED_MODULE_0__[\"api_key\"]}&page=1&query=${this.keyword}`);\n    this.data = await response.json();\n  }\n\n}\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
